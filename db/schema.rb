...
ActiveRecord::Schema[8.0].define(version: 2025_08_14_060522) do
  ...
  create_table "books_events", id: false, force: :cascade do |t|
    t.integer "book_id", null: false
    t.integer "event_id", null: false
    t.index ["book_id"], name: "index_books_events_on_book_id"
    t.index ["event_id"], name: "index_books_events_on_event_id"
  end
